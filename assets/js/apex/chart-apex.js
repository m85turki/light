...
$(document).ready(function () {
  ...
  var lineChartOptions = {
    ...
    {
      name: 'قيد التسليم',
      data: [40, 31, 95, 81, 20, 32, 19, 81, 128],
    }
  ],
  ...
  var lineAreaOptions = {
    ...
    xaxis: {
      categories: ['المرسل', 'غير المرسل', 'المرفوض', 'قيد الإنتظار'],
      opposite: true
    },
    yaxis: {
        opposite: true,
...
xaxis: {
  categories: ['إدارة الإتصالات', 'إدارة المشتريات', 'إدارة الموارد البشرية', 'إدارة الموارد', 'الإدارة'
  ],
},
yaxis: {
  labels: {
...
// ????????????
  ...
  var pieChartOptions = {
    ...
    labels: ['إدارة الإتصالات', 'إدارة المشتريات', 'إدارة الموارد البشرية', 'إدارة الموارد '],
    series: [44, 55, 13, 43],
    legend: {
      itemMargin: {
        horizontal: 2
