...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:"تفعيل لفرز العمود تصاعدي :",sSortDescending:"تفعيل لفرز العمود تنازلي :"},oPaginate:{sFirst:"الأول",sLast:"الأخير",sNext:"التالي",sPrevious:"السابق"},
sEmptyTable:"No data available in table",sInfo:"عرض _START_ إلى _END_ من _TOTAL_ إدخالات",sInfoEmpty:"عرض 0 to 0 of 0 إدخالات",sInfoFiltered:"(تمت تصفيتها من _MAX_ مجموع المدخلات)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ إدخالات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"البحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا توجد أي سجلات مطابقة"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"التاريخ",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
