function PluginsLoader(l ,s, e, o, u)
{
    if (typeof o.resource != "string")
    {
        e.ScriptLoader.add(u, l, s);
    ...
    {
        case 'advlist':
            e.ScriptLoader.add(advlistWebResourceUrl, l, s);
            break;
        case 'autolink':
            e.ScriptLoader.add(autolinkWebResourceUrl, l, s);
            break;
        case 'lists':
            e.ScriptLoader.add(listWebResourceUrl, l, s);
            break;
        case 'link':
            e.ScriptLoader.add(linkWebResourceUrl, l, s);
            break;
        case 'charmap':
            e.ScriptLoader.add(charmapWebResourceUrl, l, s);
            break;
        case 'print':
            e.ScriptLoader.add(printWebResourceUrl, l, s);
            break;
        case 'preview':
            e.ScriptLoader.add(previewWebResourceUrl, l, s);
            break;
        case 'anchor':
            e.ScriptLoader.add(anchorWebResourceUrl, l, s);
            break;
        case 'searchreplace':
            e.ScriptLoader.add(searchreplaceWebResourceUrl, l, s);
            break;
        case 'visualblocks':
            e.ScriptLoader.add(visualblocksWebResourceUrl, l, s);
            break;
        case 'fullscreen':
            e.ScriptLoader.add(fullscreenWebResourceUrl, l, s);
            break;
        case 'insertdatetime':
            e.ScriptLoader.add(insertdatetimeWebResourceUrl, l, s);
            break;
        case 'table':
            e.ScriptLoader.add(tableWebResourceUrl, l, s);
            break;
        case 'paste':
            e.ScriptLoader.add(pasteWebResourceUrl, l, s);
            break;
        case 'emoticons':
            e.ScriptLoader.add(emoticonsWebResourceUrl, l, s);
            break;
        case 'autoresize':
            e.ScriptLoader.add(autoresizeWebResourceUrl, l, s);
            break;
        case 'autosave':
            e.ScriptLoader.add(autosaveWebResourceUrl, l, s);
            break;
        case 'bbcode':
            e.ScriptLoader.add(bbcodeWebResourceUrl, l, s);
            break;
        case 'code':
            e.ScriptLoader.add(codeWebResourceUrl, l, s);
            break;
        case 'colorpicker':
            e.ScriptLoader.add(colorpickerWebResourceUrl, l, s);
            break;
        case 'contextmenu':
            e.ScriptLoader.add(contextmenutWebResourceUrl, l, s);
            break;
        case 'directionality':
            e.ScriptLoader.add(directionalityWebResourceUrl, l, s);
            break;
        case 'example_dependency':
            e.ScriptLoader.add(example_dependencyWebResourceUrl, l, s);
            break;
        case 'fullpage':
            e.ScriptLoader.add(fullpageWebResourceUrl, l, s);
            break;
        case 'hr':
            e.ScriptLoader.add(hrWebResourceUrl, l, s);
            break;
        case 'image':
            e.ScriptLoader.add(imageWebResourceUrl, l, s);
            break;
        case 'importcss':
            e.ScriptLoader.add(importcssWebResourceUrl, l, s);
            break;
        case 'layer':
            e.ScriptLoader.add(layerWebResourceUrl, l, s);
            break;
        case 'legacyoutput':
            e.ScriptLoader.add(legacyoutputtWebResourceUrl, l, s);
            break;
        case 'nonbreaking':
            e.ScriptLoader.add(nonbreakingWebResourceUrl, l, s);
            break;
        case 'noneditable':
            e.ScriptLoader.add(noneditableWebResourceUrl, l, s);
            break;
        case 'pagebreak':
            e.ScriptLoader.add(pagebreakWebResourceUrl, l, s);
            break;
        case 'save':
            e.ScriptLoader.add(saveWebResourceUrl, l, s);
            break;
        case 'spellchecker':
            e.ScriptLoader.add(spellcheckerWebResourceUrl, l, s);
            break;
        case 'tabfocus':
            e.ScriptLoader.add(tabfocusWebResourceUrl, l, s);
            break;
        case 'template':
            e.ScriptLoader.add(templateWebResourceUrl, l, s);
            break;
        case 'textcolor':
            e.ScriptLoader.add(textcolorWebResourceUrl, l, s);
            break;
        case 'textpattern':
            e.ScriptLoader.add(textpatternWebResourceUrl, l, s);
            break;
        case 'visualchars':
            e.ScriptLoader.add(visualcharsWebResourceUrl, l, s);
            break;
        case 'wordcount':
            e.ScriptLoader.add(wordcountWebResourceUrl, l, s);
            break;
        case 'example':
            e.ScriptLoader.add(exampleWebResourceUrl, l, s);
            break;
        case 'mediaWeb':
            e.ScriptLoader.add(mediaWebResourceUrl, l, s);
            break;
