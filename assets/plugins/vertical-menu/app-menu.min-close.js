!(function (n, r) {
    ...
    (r.app.menu = {
        ...
        manualScroller: {
            obj: null,
            init: function () {
                r(".main-menu").hasClass("menu-dark"), (this.obj = new PerfectScrollbar(".main-menu-content", { suppressScrollX: !0 }));
            },
            update: function () {
                var e;
                this.obj &&
                    (!0 === r(".main-menu").data("scroll-to-active") &&
                        ((e = 0 < r(".main-menu-content").find("li.active").parents("li").length ? r(".main-menu-content").find("li.active").parents("li").last().position() : r(".main-menu-content").find("li.active").position()),
                        setTimeout(function () {
            ...
            updateHeight: function () {
                ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu")) ||
                    ...
                    (r(".main-menu-content").css("height", r(n).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight()), this.update());
            },
        },
        init: function (e) {
            var n;
            0 < r(".main-menu-content").length
                ? ((this.container = r(".main-menu-content")),
                  "vertical-menu-modern" == l.data("menu") ? ((n = ""), "undefined" != typeof Storage && (n = localStorage.getItem("menuLocked")), "false" === n ? this.change("collapsed") : this.change()) : this.change("collapsed"))
                : this.drillDownMenu();
        },
        ...
        change: function (e) {
            ...
            ("vertical-menu" !== i && "vertical-menu-modern" !== i) || this.toOverlayMenu(n.name, i),
                l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), r(".menu-toggle").removeClass("is-active")),
                "horizontal-menu" != i && this.drillDownMenu(n.name),
                "xl" == n.name &&
                ...
                "sm" == n.name || "xs" == n.name ? r(".header-navbar[data-nav=brand-center]").removeClass("navbar-brand-center") : r(".header-navbar[data-nav=brand-center]").addClass("navbar-brand-center"),
                ...
                "horizontal-menu" == i && ("sm" == n.name || "xs" == n.name ? r(".menu-fixed").length && r(".menu-fixed").unstick() : r(".navbar-fixed").length && r(".navbar-fixed").sticky()),
                ("vertical-menu" !== i && "vertical-overlay-menu" !== i) ||
                            ...
                            return (
                                n
                                    ? (r(".navigation-header").hide(),
                                      r(a)
                                          .find("li a:not(:Contains(" + n + "))")
                                          .hide()
                                          .parent()
                                          .hide(),
                                      (e = r(a).find("li a:Contains(" + n + ")")).parent().hasClass("has-sub")
                                          ? (e.show().parents("li").show().addClass("open").closest("li").children("a").show().children("li").show(),
                                            0 < e.siblings("ul").length && e.siblings("ul").children("li").show().children("a").show())
                                          : e.show().parents("li").show().addClass("open").closest("li").children("a").show())
                                    : (r(".navigation-header").show(), r(a).find("li a").show().parent().show().removeClass("open")),
                                r.app.menu.manualScroller.update(),
                                !1
                            );
                        })
                        .keyup(function () {
            ...
            this.transit(
                ...
                function () {
                    !r(".main-menu").hasClass("menu-native-scroll") &&
                        r(".main-menu").hasClass("menu-fixed") &&
                        (this.manualScroller.enable(), r(".main-menu-content").css("height", r(n).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight())),
        ...
        expand: function () {
            !1 === this.expanded &&
                ("vertical-menu-modern" == l.data("menu") &&
                    (r(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-left").addClass("ft-toggle-right"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "true")),
                this.transit(
                    function () {
                    ...
                    function () {
                        r(".main-menu").hasClass("menu-native-scroll") || "horizontal-menu" == l.data("menu") ? this.manualScroller.disable() : r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                            ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu")) ||
                                !r(".main-menu").hasClass("menu-fixed") ||
                                r(".main-menu-content").css("height", r(n).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight());
                    }
                ));
        },
        collapse: function (e) {
            !1 === this.collapsed &&
                ("vertical-menu-modern" == l.data("menu") &&
                    (r(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-right").addClass("ft-toggle-left"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "false")),
                this.transit(
                    function () {
                    ...
                    function () {
                        "horizontal-menu" == l.data("menu") && l.hasClass("vertical-overlay-menu") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                            ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu")) || !r(".main-menu").hasClass("menu-fixed") || r(".main-menu-content").css("height", r(n).height() - r(".header-navbar").height()),
        ...
        changeMenu: function (e) {
            ...
            "sm" == e || "xs" == e
                ? (l.removeClass(l.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"),
                  ...
                  s.removeClass("dropdown mega-dropdown").addClass("has-sub"),
                  s.children("ul").removeClass(),
                  i.each(function (e, n) {
                  ...
                  s.find("a").removeClass("dropdown-toggle"),
                  s.find("a").removeClass("dropdown-item"),
                ...
                r(".navigation-main")
                    .on("mouseenter.app.menu", "li", function () {
                        ...
                        r(".hover", ".navigation-main").removeClass("hover"),
                            l.hasClass("menu-collapsed") &&
                                "vertical-menu-modern" != l.data("menu") &&
                                (r(".main-menu-content").children("span.menu-title").remove(),
                                r(".main-menu-content").children("a.menu-title").remove(),
                                r(".main-menu-content").children("ul.menu-content").remove(),
                                (s = i.find("span.menu-title").clone()),
                                i.hasClass("has-sub") || ((e = i.find("span.menu-title").text()), (n = i.children("a").attr("href")), "" !== e && ((s = r("<a>")).attr("href", n), s.attr("title", e), s.text(e), s.addClass("menu-title"))),
                                (a = i.css("border-top") ? i.position().top + parseInt(i.css("border-top"), 10) : i.position().top),
                                "vertical-compact-menu" !== l.data("menu") && s.appendTo(".main-menu-content").css({ position: "fixed", top: a }),
                                i.hasClass("has-sub") && i.hasClass("nav-item") && (i.children("ul:first"), t.adjustSubmenu(i))),
                            i.addClass("hover");
                    })
                    ...
                    r(".navbar-header, .main-menu")
                        .on("mouseenter", function () {
                            var e;
                            "vertical-menu-modern" == l.data("menu") &&
                                (r(".main-menu, .navbar-header").addClass("expanded"), l.hasClass("menu-collapsed")) &&
                                ((e = r(".main-menu li.menu-collapsed-open"))
                                    .children("ul")
                                    .hide()
                            ...
                            l.hasClass("menu-collapsed") &&
                                ...
                                setTimeout(function () {
                                    ...
                                    0 === r(".main-menu:hover").length &&
                                        ...
                                        (r(".main-menu, .navbar-header").removeClass("expanded"), l.hasClass("menu-collapsed")) &&
                                        ((n = (e = r(".main-menu li.open")).children("ul")),
